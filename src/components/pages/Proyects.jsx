            ...
            <div className={`container ${Theme}`}>
                ...
                <div className="proyects">
                    ...
                    <Slider {...sliderSettings}>
                            ...
                            description={"Desarrollo de página oficial del comedor estudiantil de la provincia de La Rioja con sistema de reserva diario, manejo de usuarios y automatización de los procesos.Actualmente, tareas de mantenimiento, control de los procesos y backups semanales"} link={"mundi"}/>

                            <ProyectItem srcImage={"../src/assets/projects-images/agrocommerce.jpeg"} title={"AgroCommerce"} description={"Sistema web que brinda al agricultor la posibilidad de llevar un control y gestión de calidad de su cultivo y tierras, entregando información para lo toma de decisiones, apoyándose en funcionalidades como: Control de suelo (IA): teniendo en cuenta el tipo de cultivo sembrado, la humedad requerida y el suelo de la zona donde se encuentra. Asistencia y prevención de plagas: información sobre qué plagas acechan los cultivos. Información sobre diferentes cultivos (época de sembrado y cosecha). *Alertas climatológicas."} proyectLink={"https://github.com/InsiderUser/AgroCommerce"} link={"github"}/>

                            <ProyectItem srcImage={"../src/assets/projects-images/cc11.PNG"} title={"Calculadora de Bolo Alimenticio para Diabéticos"} description={"Sistema web desarrollado en la cátedra de Seminario de Actualización II, utilizando tecnologías innovadoras y recientes como, ReactPy + MongoDB. El sistema consiste en una calculadora, teniendo en cuenta variables reales, para el cálculo de inyección de insulina recomendado para el ususario. Inspirado en personas que padecen Diabetes, una idea con potencial."} proyectLink={"https://github.com/AleRomanazzi/Calculadora-Bolo"} link={"github"}/>

                            <ProyectItem srcImage={"../src/assets/projects-images/lunar-flight.avif"} title={"Reconstrucción del Juego Lunar Flight"} description={"Juego desarrollado en lenguaje C# utilizando el framework Monogame.net (Visual Basic.NET) para la cátedra de Programación II de la Universidad Nacional de La Rioja."} proyectLink={"https://github.com/AleRomanazzi/Lunar-Flight_MG"} link={"github"}/>

                            <ProyectItem srcImage={"../src/assets/projects-images/portfolio.png"} title={"Mi Portfolio 2023"} description={"Este proyecto es el portfolio en el que usted se encuentra ahora."} proyectLink={"https://github.com/AleRomanazzi/My-Portfolio-2023"} link={"github"}/>
